        ...
        <div className="container-fluid p-12 h-full">
          <div className="mb-32">
            {librosLeidos.length > 0 && (
              <>
                <h2 className="text-3xl text-center _sm:text-left font-bold mb-4">
                  Seguir Leyendo
                </h2>
                <div className="grid gap-8 grid-cols-1 _sm:grid-cols-2 _md:grid-cols-3 _lg:grid-cols-4 _xl:grid-cols-5 pb-20 shadow-[0_19px_10px_-19px_rgba(0,0,0,0.3)]">
            ...
            <div className="grid gap-8 grid-cols-1 _sm:grid-cols-2 _md:grid-cols-3 _lg:grid-cols-4 _xl:grid-cols-5">
