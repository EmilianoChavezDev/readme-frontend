...
export default function Page() {
  const { getReports, isLoading } = useReport();
    ...
    <>
      ...
      >
        <div className="flex flex-col gap-3">
          ...
          <span>
            Ingresa tu email <b className="text-red-900">*</b>
          </span>

          <input
            type="email"
            className="text-md border rounded-lg p-3 text-gray-900 border-gray-400 outline-none"
            value={userEmail}
