...
export default function Page() {
  ...
  return (
    <>
      ...
      >
        <p>
          ¿Estás seguro de cambiar el rol a <b>Usuario</b>?
        </p>
      </Modal>
      <AddModeratorModal
        show={showAddModeratorModal}
      ...
      <div className="flex gap-3 px-20 py-9">
        ...
        <div className="grow flex flex-col gap-3">
          ...
          <div className="flex flex-col items-center gap-3 border border-gray-300 rounded-md py-5 px-2">
            <h1 className="text-xl font-semibold">LISTA DE MODERADORES</h1>
            <table className="w-full">
              <thead>
                <tr className="h-14 border-b border-gray-200">
                  ...
                  <th className="text-end font-semibold">
                    Registrado en Fecha
                  </th>
                </tr>
              </thead>
                ...
                {data?.moderadores?.map((moderator, index) => (
                  <tr
                    ...
                    className={`h-14 hover:bg-green-100 cursor-pointer ${
                      moderator.id === moderatorSelected?.id
                  ...
                  >
                    ...
                    >
                      {moment().diff(
                        moment(moderator.fecha_de_nacimiento),
                        "years"
                      )}{" "}
                      años
                    </td>
                    ...
                    >
                      {moderator?.role_updated_at
                        ? moment(moderator?.role_updated_at).format(
                            "DD-MM-YYYY"
                          )
                        : ""}
                    </td>
        ...
        <div className="w-96 flex flex-col gap-6">
          {moderatorSelected ? (
            <>
              ...
              <div className="border border-gray-300 rounded-md p-3 flex flex-col gap-3">
                <div className="flex flex-col gap-3 pb-3 border-b border-colorPrimario">
                  <span className="text-gray-700">
                    {moderatorSelected?.nombre ?? moderatorSelected?.username}
                  </span>
                  <div className="flex gap-1">
                    <span className="font-semibold">Edad:</span>
                    <span className="text-gray-700">
                      {moment().diff(
                        moment(moderatorSelected.fecha_de_nacimiento),
                        "years"
                      )}{" "}
                      años
                    </span>
                ...
                {moderatorSelected?.registrado_por && (
                  <div className="flex flex-col gap-3 pb-3 border-b border-colorPrimario">
                    ...
                    <div className="flex gap-1">
                      ...
                      <span className="text-gray-700">
                        {moment(moderatorSelected?.role_updated_at).format(
                          "DD-MM-YYYY"
                        )}
                      </span>
                    </div>
                ...
                <article className="bg-coldCanada flex flex-col gap-2 p-3 dark:bg-dark-darkColorNeutral">
                  ...
                  <div className="flex justify-between">
                    <div className="flex gap-2 items-center">
                      <span className="text-2xl font-semibold">
                        {moderatorSelected?.reportes_resueltos_libros}
                      </span>
                      <span className="text-sm text-gray-600">Resueltos</span>
                    </div>
                    <div className="flex gap-2 items-center">
                      <span className="text-2xl font-semibold">
                        {moderatorSelected?.reportes_rechazados_libros}
                      </span>
                ...
                <article className="bg-coldCanada flex flex-col gap-2 p-3 dark:bg-dark-darkColorNeutral">
                  ...
                  <div className="flex justify-between">
                    <div className="flex gap-2 items-center">
                      <span className="text-2xl font-semibold">
                        {moderatorSelected?.reportes_resueltos_comentarios}
                      </span>
                      <span className="text-sm text-gray-600">Resueltos</span>
                    </div>
                    <div className="flex gap-2 items-center">
                      <span className="text-2xl font-semibold">
                        {moderatorSelected?.reportes_rechazados_comentarios}
                      </span>
                      <span className="text-sm text-gray-600">Rechazados</span>
                    </div>
                  </div>
                ...
                <article className="bg-coldCanada flex flex-col gap-2 p-3 dark:bg-dark-darkColorNeutral">
                  ...
                  <div className="flex justify-between">
                    <div className="flex gap-2 items-center">
                      <span className="text-2xl font-semibold">
                        {moderatorSelected?.reportes_resueltos_usuarios}
                      </span>
                      <span className="text-sm text-gray-600">Resueltos</span>
                    </div>
                    <div className="flex gap-2 items-center">
                      <span className="text-2xl font-semibold">
                        {moderatorSelected?.reportes_rechazados_usuarios}
                      </span>
                      <span className="text-sm text-gray-600">Rechazados</span>
                    </div>
                  </div>
              ...
              <div>
                <button
                  className="h-10 rounded-md px-2 bg-red-900 text-white hover:brightness-90"
