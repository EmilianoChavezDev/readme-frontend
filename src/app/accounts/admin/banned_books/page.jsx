  ...
  return (
    <>
            ...
            {reportSelected ? (
              <>
                ...
                <div className="border border-gray-300 rounded-md p-3 flex flex-col gap-3 py-5">
                  ...
                  <div className="flex gap-1">
                    <span className="font-semibold">Autor del Libro:</span>
                ...
                {reportSelected?.estado !== "aceptado" &&
                  reportSelected?.estado !== "rechazado" && (
                    <div className="flex justify-between text-white">
                      ...
                      <div>
                        <button
                          className="h-10 rounded-md _md:h-12 px-2 bg-red-900 hover:brightness-90"
      ...
      >
        <div className="flex flex-col gap-3">
          <p>
            {`Aceptar apleacion de este libro \"${reportSelected?.libro}\"?`}
          </p>
        </div>
      </Modal>
      ...
      >
        <div className="flex flex-col gap-3">
          <p>
            {`Rechazar la apleacion de este libro \"${reportSelected?.libro}\"?`}
          </p>
        </div>
      </Modal>
    </>
