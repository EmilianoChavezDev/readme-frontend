...
export default function RootLayout({ children }) {
  ...
  const [paths, setPaths] = useState([
    {
      path: "/accounts/admin/banned_books",
      name: "Libros Baneados",
      show: true,
    },
    {
      path: "/accounts/admin/banned_users",
      name: "Usuarios Baneados",
      show: true,
    },
    {
      path: "/accounts/admin/banned_comments",
      name: "Comentarios Baneados",
      show: true,
    },
    {
      path: "/accounts/admin/manage_moderators",
      name: "Moderadores",
      show: role === "moderador",
    },
  ]);
    ...
    >
      <div className="relative flex flex-col gap-3 px-20 py-9">
        ...
        <div className="flex justify-between h-10 items-center">
          ...
          {role === "moderador" &&
            pathname === "/accounts/admin/manage_moderators" && (
              <button
                className="h-10 px-2 rounded-md bg-colorPrimario hover:bg-colorHoverPrimario text-white flex items-center gap-1"
