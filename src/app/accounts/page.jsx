    ...
    <div className="flex p-6 sm:py-8 sm:px-20 flex-col gap-3 sm:gap-10">
      ...
      <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4">
          ...
          <div className="flex flex-row sm:flex-col items-center sm:items-start p-3 gap-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-sm text-gray-700">
                Proporcionar o cambiar datos personales, actualiza tu contraseña
              </p>
            </div>
          </div>
        </Link>
        ...
        >
          <div className="flex flex-row sm:flex-col items-center sm:items-start p-3 gap-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-sm text-gray-700">
                Obtener un informe de las interacciones de los usuarios con los
                libros publicados
              </p>
            </div>
          </div>
        ...
        >
          <div className="flex flex-row sm:flex-col items-center sm:items-start p-3 gap-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-sm text-gray-700">
                Explora tu historial de eliminaciones para recuperar tus libros
                y capítulos
              </p>
            </div>
          </div>
        ...
        >
          <div className="flex flex-row sm:flex-col items-center sm:items-start p-3 gap-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-sm text-gray-700">
                Mira nuestras políticas de Privacidad
              </p>
            </div>
          </div>
        </Link>
        ...
        >
          <div className="flex flex-row sm:flex-col items-center sm:items-start p-3 gap-4">
            <span className="w-8 h-8">
              <GiThorHammer className="size-11" />
            </span>
            <div className="flex flex-col gap-1">
              <h2 className="font-semibold">Apelación de Sanciones</h2>
              <p className="text-sm text-gray-700">
                Gestiona tu contenido sancionado por moderadores libros y
                comentarios{" "}
              </p>
            </div>
          </div>
