        ...
        {isMyProfile && (
          <div className="flex items-end justify-end mb-2 mx-2 ">
            <button
             ...
             border border-colorPrimario bg-transparent hover:bg-colorHoverPrimario gap-x-2 dark:bg-dark-darkColorButtons dark:hover:bg-dark-darkColorHover dark:border-dark-darkColorButtons"
              onClick={onClick}
            >
              {info}
            </button>
